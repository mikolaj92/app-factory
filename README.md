...
**Tag:** `v0.6.15` (identity-adapter composition; multi-user BOM is v0.6.15 / my-auth v0.4.8 / my-usermanager v0.5.11)
...
|-------|------|----------------------|
| **app-factory** (this repo) | Bundled chrome, one FastAPI mount, and the shared Jinja shell | `git` tag `v0.6.15` directly; multi-user hosts follow `COMPAT.md` |
...
[tool.uv.sources]
app-factory = { git = "https://github.com/mikolaj92/app-factory.git", tag = "v0.6.15" }
...
|-------------|---------------|-------|
| **v0.6.15** | **1.0.2** | Additive on v0.6.11: `install_identity_adapters` + focused passkey/usermanager/session helpers; BOM row my-auth v0.4.8 / my-usermanager v0.5.11. No chrome change. |
