...
def test_bom_pins_align_with_example_pyproject() -> None:
    ...
    assert bom["pins"]["app-factory"] == f"v{tomllib.loads((REPO_ROOT / 'pyproject.toml').read_text())['project']['version']}"
