...
| Package | Tag |
|---------|-----|
| app-factory | `v0.7.6` (editable path while developing this repo) |
| my-auth | `v0.5.6` |
...
(`passkey_enrollment_capabilities`) is stamped by my-usermanager v0.6.7
...
app-factory to v0.7.6 (and UM to v0.6.7 if still on v0.5.7).
