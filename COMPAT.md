...
|-------------|---------|----------------|-------|
| **v0.5.3** | **v0.3.8** | **v0.3.2** | Header theme/locale; foot Login/Account; **Log out only on account page** |
...
[tool.uv.sources]
app-factory = { git = "https://github.com/mikolaj92/app-factory", tag = "v0.5.3" }
```
